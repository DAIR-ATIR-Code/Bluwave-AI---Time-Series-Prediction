...
#%%
    ...
    for variation in product(*values):
        ...
        #print(variation)
        model, history, metric = create_and_fit_model(train.copy(), \
                                                      validate.copy(), \
                                                      params)
    ...
    model.save(project_dir + '\\models\\trained_model.hdf5')
    history.to_csv(project_dir + '\\models\\training_history.csv')
    ...
    model.save(project_dir + '\\models\\final_model.hdf5')
    final_history.to_csv(project_dir + '\\models\\final_history.csv')
